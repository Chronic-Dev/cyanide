/**
  * GreenPois0n Cynanide - iPod4,1/8B117/iBEC/offsets.h
...
// Standard offsets
#define TARGET_FREE                       (0xFF5C+1)
#define TARGET_MALLOC                     (0x101E0+1)
#define TARGET_JUMP_TO                    (0x1422C+1)
#define TARGET_PRINTF                     (0x19994+1)
#define TARGET_VPRINTF                    (0x19264+1)
...
// Task functions
#define TARGET_TASK_YIELD                 (0x14B28+1)
#define TARGET_TASK_RUNNING               (0x22738)
#define TARGET_TASK_LIST                  (0x227D0)

// AES offsets
#define TARGET_AES_CRYPTO_CMD             (0x15E3C+1)
